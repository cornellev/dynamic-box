...
#include "cluster_node/msg/detail/obstacle__rosidl_typesupport_fastrtps_c.h"
...
using _Obstacle__ros_msg_type = cluster_node__msg__Obstacle;
...
static uint32_t _Obstacle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cluster_node__msg__Obstacle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cluster_node__msg__Obstacle;
    is_plain =
      (
      offsetof(DataType, blocking) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Obstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cluster_node__msg__Obstacle(
