...
#include "cluster_node/msg/detail/obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cluster_node::msg::Obstacle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cluster_node::msg::Obstacle & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cluster_node::msg::Obstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cluster_node::msg::Obstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cluster_node::msg::Obstacle *>(
    untyped_ros_message);
...
{
  return &cluster_node::msg::typesupport_fastrtps_cpp::_Obstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cluster_node, msg, Obstacle)() {
  return &cluster_node::msg::typesupport_fastrtps_cpp::_Obstacle__handle;
}
