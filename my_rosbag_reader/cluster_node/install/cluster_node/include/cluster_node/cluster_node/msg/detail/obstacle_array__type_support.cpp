...
{
  new (message_memory) cluster_node::msg::ObstacleArray(_init);
}

void ObstacleArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cluster_node::msg::ObstacleArray *>(message_memory);
  typed_message->~ObstacleArray();
}

size_t size_function__ObstacleArray__obstacles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<cluster_node::msg::Obstacle> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<cluster_node::msg::Obstacle> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<cluster_node::msg::Obstacle> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const cluster_node::msg::Obstacle *>(
    get_const_function__ObstacleArray__obstacles(untyped_member, index));
  auto & value = *reinterpret_cast<cluster_node::msg::Obstacle *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<cluster_node::msg::Obstacle *>(
    get_function__ObstacleArray__obstacles(untyped_member, index));
  const auto & value = *reinterpret_cast<const cluster_node::msg::Obstacle *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleArray_message_member_array[2] = {
  {
    ...
    offsetof(cluster_node::msg::ObstacleArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<cluster_node::msg::Obstacle>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(cluster_node::msg::ObstacleArray, obstacles),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleArray_message_members = {
  "cluster_node::msg",  // message namespace
  "ObstacleArray",  // message name
  2,  // number of fields
  sizeof(cluster_node::msg::ObstacleArray),
...
get_message_type_support_handle<cluster_node::msg::ObstacleArray>()
{
  return &::cluster_node::msg::rosidl_typesupport_introspection_cpp::ObstacleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cluster_node, msg, ObstacleArray)() {
  return &::cluster_node::msg::rosidl_typesupport_introspection_cpp::ObstacleArray_message_type_support_handle;
}
