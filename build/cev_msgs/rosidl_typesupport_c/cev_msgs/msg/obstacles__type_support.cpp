...
static const _Obstacles_type_support_symbol_names_t _Obstacles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cev_msgs, msg, Obstacles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cev_msgs, msg, Obstacles)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cev_msgs, msg, Obstacles)() {
  return &::cev_msgs::msg::rosidl_typesupport_c::Obstacles_message_type_support_handle;
}
