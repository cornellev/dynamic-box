...
cev_msgs__msg__Obstacle__create()
{
  ...
  cev_msgs__msg__Obstacle * msg = (cev_msgs__msg__Obstacle *)allocator.allocate(sizeof(cev_msgs__msg__Obstacle), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(cev_msgs__msg__Obstacle));
  bool success = cev_msgs__msg__Obstacle__init(msg);
  if (!success) {
...
cev_msgs__msg__Obstacle__destroy(cev_msgs__msg__Obstacle * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    cev_msgs__msg__Obstacle__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
cev_msgs__msg__Obstacle__Sequence__init(cev_msgs__msg__Obstacle__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cev_msgs__msg__Obstacle * data = NULL;

  if (size) {
    data = (cev_msgs__msg__Obstacle *)allocator.zero_allocate(size, sizeof(cev_msgs__msg__Obstacle), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = cev_msgs__msg__Obstacle__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        cev_msgs__msg__Obstacle__fini(&data[i - 1]);
      }
...
cev_msgs__msg__Obstacle__Sequence__fini(cev_msgs__msg__Obstacle__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      cev_msgs__msg__Obstacle__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cev_msgs__msg__Obstacle__Sequence * array = (cev_msgs__msg__Obstacle__Sequence *)allocator.allocate(sizeof(cev_msgs__msg__Obstacle__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = cev_msgs__msg__Obstacle__Sequence__init(array, size);
  if (!success) {
...
cev_msgs__msg__Obstacle__Sequence__destroy(cev_msgs__msg__Obstacle__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    cev_msgs__msg__Obstacle__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
cev_msgs__msg__Obstacle__Sequence__are_equal(const cev_msgs__msg__Obstacle__Sequence * lhs, const cev_msgs__msg__Obstacle__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!cev_msgs__msg__Obstacle__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  cev_msgs__msg__Obstacle__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(cev_msgs__msg__Obstacle);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    cev_msgs__msg__Obstacle * data =
      (cev_msgs__msg__Obstacle *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cev_msgs__msg__Obstacle__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          cev_msgs__msg__Obstacle__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!cev_msgs__msg__Obstacle__copy(
