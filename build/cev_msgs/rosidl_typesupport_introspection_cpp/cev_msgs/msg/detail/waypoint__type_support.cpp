...
{
  new (message_memory) cev_msgs::msg::Waypoint(_init);
}

void Waypoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cev_msgs::msg::Waypoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Waypoint_message_member_array[5] = {
  {
    ...
    offsetof(cev_msgs::msg::Waypoint, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cev_msgs::msg::Waypoint, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cev_msgs::msg::Waypoint, v),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cev_msgs::msg::Waypoint, tau),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cev_msgs::msg::Waypoint, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::cev_msgs::msg::rosidl_typesupport_introspection_cpp::Waypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cev_msgs, msg, Waypoint)() {
  return &::cev_msgs::msg::rosidl_typesupport_introspection_cpp::Waypoint_message_type_support_handle;
}
