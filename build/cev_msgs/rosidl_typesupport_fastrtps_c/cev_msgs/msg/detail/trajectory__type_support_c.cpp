...
#include "cev_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "cev_msgs/msg/detail/waypoint__functions.h"  // waypoints
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_cev_msgs__msg__Waypoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_cev_msgs__msg__Waypoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cev_msgs, msg, Waypoint)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_cev_msgs
...
using _Trajectory__ros_msg_type = cev_msgs__msg__Trajectory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: waypoints
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, cev_msgs, msg, Waypoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: waypoints
  {
    ...
    if (ros_message->waypoints.data) {
      cev_msgs__msg__Waypoint__Sequence__fini(&ros_message->waypoints);
    }
...
size_t get_serialized_size_cev_msgs__msg__Trajectory(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory__ros_msg_type * ros_message = static_cast<const _Trajectory__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cev_msgs__msg__Waypoint(
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cev_msgs__msg__Trajectory(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cev_msgs
size_t max_serialized_size_cev_msgs__msg__Trajectory(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cev_msgs__msg__Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = cev_msgs__msg__Trajectory;
    is_plain =
      (
      offsetof(DataType, timestep) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cev_msgs__msg__Trajectory(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cev_msgs, msg, Trajectory)() {
