...
class Obstacles(metaclass=Metaclass_Obstacles):
    ...
    _fields_and_field_types = {
        'obstacles': 'sequence<cev_msgs/Obstacle>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['cev_msgs', 'msg'], 'Obstacle')),  # noqa: E501
    )
