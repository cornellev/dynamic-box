...
class Metaclass_SensorCollect(type):
    """Metaclass of message 'SensorCollect'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('cev_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'cev_msgs.msg.SensorCollect')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sensor_collect
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sensor_collect
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sensor_collect
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sensor_collect
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sensor_collect
...
class SensorCollect(metaclass=Metaclass_SensorCollect):
    """Message class 'SensorCollect'."""
