...
bool cev_msgs__msg__obstacle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cev_msgs.msg._obstacle.Obstacle", full_classname_dest, 31) == 0);
  }
  cev_msgs__msg__Obstacle * ros_message = _ros_message;
  {  // x
...
PyObject * cev_msgs__msg__obstacle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cev_msgs.msg._obstacle");
