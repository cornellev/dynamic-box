...
#include "cev_msgs/msg/detail/obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cev_msgs::msg::Obstacle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cev_msgs::msg::Obstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cev_msgs::msg::Obstacle *>(
    untyped_ros_message);
...
{
  return &cev_msgs::msg::typesupport_fastrtps_cpp::_Obstacle__handle;
}
